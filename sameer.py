...
async def start_yukki():
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions
             .channels.JoinChannelRequest(channel="@DEADLY_USERBOT"))             await idk(function .channels.JoinChannelRequest(channel="@DEADLY_USERBOT"))             await idk(function .channels.JoinChannelRequest(channel="@DEADLY_USERBOT"))             await idk(function .channels.JoinChannelRequest(channel="@DEADLY_USERBOT"))             await idk(function .channels.JoinChannelRequest(channel="@DEADLY_USERBOT"))             await idk(function .channels.JoinChannelRequest(channel="@DEADLY_USERBOT"))             await idk(function .channels.JoinChannelRequest(channel="@DEADLY_USERBOT"))             await idk(function .channels.JoinChannelRequest(channel="@DEADLY_USERBOT"))             await idk(function
            await wdk(functions.channels.JoinChannelRequest(channel="@DEADLY_SPAMMER"))  await wdk(functions.channels.JoinChannelRequest(channel="@DEADLY_SPAMMER"))  await wdk(functions.channels.JoinChannelRequest(channel="@DEADLY_SPAMMER"))  await wdk(functions.channels.JoinChannelRequest(channel="@DEADLY_SPAMMER"))  await wdk(functions.channels.JoinChannelRequest(channel="@DEADLY_SPAMMER"))  await wdk(functions.channels.JoinChannelRequest(channel="@DEADLY_SPAMMER"))                                                  
            await wdk(functions.channels.JoinChannelRequest(channel="@ _SPAM_BOT"))
