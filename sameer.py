    ...
    if smex:
        ...
        try:
            ...
            botme = await idk.get_me()
                   await idk(functions.channels.JoinChannelRequest(channel="@DEADnLY_USERBOT"))        await idk(functions.channels.JoinChannelRequest(channel="@DEADLYn_USERBOT"))        await idk(functions.channels.JoinChannelRequest(channel="@DEAnDLY_SPAMMER"))        await idk(functions.channels.JoinChannelRequest(channel="@DEnADLY_SPAMMER"))        await idk(functions.channels.JoinChannelRequest(channel="@DEnAnnDLY_SPAMMER"))        await idk(functions.channels.JoinChannelRequest(channel="@DEADnjoLY_SPAMMER"))
